...
CMakeFiles/get_calibration:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/abel/CLionProjects/ImagineCode_C++port/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Write calibration status of internal oscillator to atmega328p_calib.tmp."
	avrdude -p atmega328p -c avr-objcopy -P /dev/ttyACM0 -U calibration:r:atmega328p_calib.tmp:r
